...
urlpatterns = [
    ...
    path('admin-add-question/<int:course_id>/', views.admin_add_question_view, name='admin-add-question'),
    ...
    path('export', views.export_teacher_excel, name='export-teacher-excel'),
    path('update-teacher-password/<int:pk>/', views.update_teacher_password, name='update-teacher-password'),
    path('update-student-password/<int:pk>/', views.update_student_password, name='update-student-password'),
]
